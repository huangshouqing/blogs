<!--
 * @Author: hasan
 * @Date: 2021-06-10 11:30:27
 * @LastEditTime: 2021-06-10 13:07:20
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \vue-blog\src\views\register.vue
-->
        ...
        <el-form-item label=""
          ...
          <el-row>
            ...
            <el-col :span='22'>
              <el-input class="inps"
                placeholder='真实名称'
                v-model="loginForm.realname"></el-input>
            </el-col>
          </el-row>
        </el-form-item>
        <el-form-item label=""
  ...
  methods: {
    ...
    createStar(params) {
      ...
      if (params) {
        ...
        for (var e = 0; e < 30; e++) {
          this.stars[e].shadowColor = this.shadowColorList[
            Math.floor(Math.random() * this.shadowColorList.length)
          ];
        }
    ...
    submitForm() {
      this.$refs.loginForm.validate((valid) => {
        if (valid) {
          this.$axios.post("api/user/register", this.loginForm).then((res) => {
            res = res.data;
            if (res.code === 0) {
